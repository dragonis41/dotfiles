...
function install_packages(){
    ...
    sudo -H -u dragonis41 bash -c 'yay --noconfirm --answerclean All --answerdiff None --answeredit None --cleanafter --removemake --sudoloop -S bind linux61 linux61-headers autojump fprintd fd jq dialog gum noto-fonts-emoji mtr'
}
