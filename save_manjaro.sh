...
files=(
    ...
    "/home/${SUDO_USER}/.local/share/konsole/Custom.profile:${backup_folder}/${SUDO_USER}/.local/konsole/"
    "/home/${SUDO_USER}/.nanorc:${backup_folder}/${SUDO_USER}/"
    "/home/${SUDO_USER}/.p10k.zsh:${backup_folder}/${SUDO_USER}/"
    "/home/${SUDO_USER}/.ssh/config:${backup_folder}/${SUDO_USER}/.ssh/"
    "/home/${SUDO_USER}/.zshrc:${backup_folder}/${SUDO_USER}/"

    ########################### Git Hooks ###########################
    # Pre commit
    "/home/${SUDO_USER}/.git-hooks/pre-commit:${backup_folder}/${SUDO_USER}/.git-hooks/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/01.check-for-private-key.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/02.check-for-env-files.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/03.check-for-credentials.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/04.remove-trailing-space.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/05.fix-end-of-files.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/06.format-go-files.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/07.validate-json-files.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    "/home/${SUDO_USER}/.git-hooks/pre-commit.d/08.validate-xml-files.hook:${backup_folder}/${SUDO_USER}/.git-hooks/pre-commit.d/"
    # Commit msg
    "/home/${SUDO_USER}/.git-hooks/commit-msg:${backup_folder}/${SUDO_USER}/.git-hooks/"
    "/home/${SUDO_USER}/.git-hooks/commit-msg.d/01.check-message.hook:${backup_folder}/${SUDO_USER}/.git-hooks/commit-msg.d/"
    # Post update
